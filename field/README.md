...
| `CONVERSION_AND_USAGE.md` | 转换流程与使用说明(详细文档) |
...
```bash
# 1. 建立虚拟环境并安装依赖
python3 -m venv .step_convert_venv
.step_convert_venv/bin/pip install -r requirements-conversion.txt

# 2. 放置 RMUC2026_V2.0.0.stp 于本目录

# 3. 执行转换(详细步骤见 CONVERSION_AND_USAGE.md)
python3 step_to_nav_maps.py
```
